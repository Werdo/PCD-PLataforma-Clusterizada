...
### 16_reset_and_prepare_facit.sh
# Resetea completamente el frontend FACIT, reinstala dependencias y genera la imagen Docker
# Autor: Pedro / ChatGPT
# Fecha: 2025-05-31
...
FOLDER="facit"
ZIP_SOURCE="/home/ppelaez/scripts/facit-vite.zip"
...
echo "✅ FACIT desplegado correctamente."
