...
### deploy_gateway_t301.sh
# Construye y sube el gateway T301 al registry privado
# Autor: Pedro / ChatGPT
# Fecha: 2025-06-04
...
def main():
    while True:
        print("[T301] Escuchando puerto serie y enviando datos...")
        time.sleep(10)
...
if [ ! -f "$ENV_FILE" ]; then
  ...
  echo "# Configuración para gateway T301" > "$ENV_FILE"
fi
